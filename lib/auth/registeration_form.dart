            ...
            child: Column(children: [
              Padding(
                ...
                child: DropdownButton(
                  hint: const Text('Select Account Type', style: TextStyle(fontWeight: FontWeight.normal, fontSize: 22)),
                  value: dropdownValue,
                  icon: Icon(
              ...
              Padding(
                ...
                child: Container(
                  child: TextFormField(
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return dropdownValue == "Business Account" ? "Enter Business Name" : 'Enter Your Name';
                      }
                      setState(() {
                    ...
                    decoration: InputDecoration(
                      prefixIcon: Icon(
                        dropdownValue == "Business Account" ? Icons.business_outlined : Icons.person_outlined,
                        color: Theme.of(context).primaryColor,
                      ),
                      labelText: dropdownValue == "Business Account" ? "Business Name" : 'Name',
                ...
                child: Container(
                  child: TextFormField(
                    ...
                    validator: (value) {
                      ...
                      final bool isValidEmail = EmailValidator.validate(_emailTextController.text);
                      if (!isValidEmail) {
                          ...
                          if (validateAndSave()) {
                            ...
                            APIService.signup(model).then((res) {
                              ...
                              if (res.data != null) {
                                ...
                                services.scaffold(message: "Error registering user: ${res.message}", context: context);
                              }
                            });
                          }
                        },
